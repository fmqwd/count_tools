...
class ColorPickerDialog extends StatelessWidget {
  ...
  ColorPickerDialog({super.key, required this.onColorChanged});
...
void showThemePicker(BuildContext context, ValueChanged<bool> changed) =>
    showDialog(
        context: context,
        builder: (context) => ColorPickerDialog(onColorChanged: changed));
